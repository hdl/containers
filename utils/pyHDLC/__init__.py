...
DefaultOpts: Dict[str, Tuple[str, str, str]] = {
    ...
    "pkg/apicula": [None, "pkg", None],
    "arachne-pnr": [None, None, None],
    "pkg/arachne-pnr": [None, "pkg", None],
    ...
    "pkg/ghdl-yosys-plugin": [None, "pkg", None],
    ...
    "pkg/gtkwave": [None, "pkg", None],
    "gtkwave": [None, None, None],
    "pkg/icestorm": [None, "pkg", None],
    ...
    "pkg/iverilog": [None, "pkg", None],
    "klayout": [None, None, None],
    "pkg/klayout": [None, "pkg", None],
    "magic": [None, None, None],
    "pkg/magic": [None, "pkg", None],
    "netgen": [None, None, None],
    "pkg/netgen": [None, "pkg", None],
    ...
    "pkg/openfpgaloader": [None, "pkg", None],
    "prjoxide": [None, None, None],
    "pkg/prjoxide": [None, "pkg", None],
    "prjtrellis": [None, None, None],
    "pkg/prjtrellis": [None, "pkg", None],
    "prog": [None, None, None],
    "sim": [None, None, None],
