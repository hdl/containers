...
# Change to https://github.com/RTimothyEdwards once
# https://github.com/RTimothyEdwards/magic/pull/75 is merged.
RUN git clone https://github.com/mithro/magic.git /tmp/magic \
 && mkdir -p /opt/magic/ \
 && cd /tmp/magic \
 && ./configure \
 && make -j$(nproc) \
