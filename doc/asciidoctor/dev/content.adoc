...
See https://cloud.google.com/container-registry/docs/advanced-authentication#json-key[cloud.google.com/container-registry/docs/advanced-authentication#json-key].
