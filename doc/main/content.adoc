...
* `debian/bullseye` based on https://hub.docker.com/_/debian[debian:bullseye-slim]
** Available as https://gcr.io/hdl-containers/debian/bullseye[image:https://img.shields.io/badge/-gcr.io/hdl--containers/debian/bullseye-555555.svg?longCache=true&style=flat-square&logo=Google%20Cloud&logoColor=f2f1ef[title='Google Container Registry']]
** Mirrored to
  https://github.com/hdl/containers/packages[image:https://img.shields.io/badge/-ghcr.io/hdl/debian/bullseye-555555.svg?longCache=true&style=flat-square&logo=GitHub&logoColor=f2f1ef[title='GitHub Container Registry']]
