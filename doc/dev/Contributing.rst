...
1. Create or update dockerfile(s).
  ...
  * For each tool and collection, a Dockerfile recipe exists.
     ...
     * Optionally, add tools to multiple collections at the same time by either using the same dockerfile or creating
       one dockerfile for the tool in each collection.
